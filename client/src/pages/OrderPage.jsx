  ...
  return (
    <div className="mx-auto container">
      ...
      <div className="flex flex-col ">
        ...
        <div key={index} className="flex items-center py-4 justify-between border-y border-gray-300/70 ">
        <div className="flex items-center gap-3">
            <div className="">
                <img src="" alt="" />
            </div>
            <div className="flex flex-col gap-3">
                <p className="text-[#494949] font-500 font-medium text-[22px] ">{item.title}</p>
                <div className="flex items-center gap-3 text-[#494949] font-300 text-[20px] ">
                    <p className="">{item.price}</p>
                    <p className="">Quantity: 1</p>
                    <p className="">Size: L</p>
                </div>
                <div className="text-[18px]">Date: <span className="text-[#989898]">25, May, 2024</span></div>
            </div>
        </div>
        <div className="flex items-center gap-3">
